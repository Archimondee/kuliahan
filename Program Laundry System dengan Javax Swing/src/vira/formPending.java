 ...
 * @author Archi3
 */
public class formPending extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formPending.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formPending().setVisible(true);
            }
        });
    }
...
public void tampilData(){
    ...
    try{
        konekDatabase();
        String sql = "SELECT * FROM data_laundry INNER JOIN detail_laundry ON data_laundry.no_antrian = detail_laundry.no_antrian WHERE detail_laundry.status_cucian = 'Pending'";
